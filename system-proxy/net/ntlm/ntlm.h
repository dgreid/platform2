...
#ifndef SYSTEM_PROXY_NET_NTLM_NTLM_H_
#define SYSTEM_PROXY_NET_NTLM_NTLM_H_
...
NET_EXPORT_PRIVATE void GenerateNtlmHashV1(
    const base::string16& password, base::span<uint8_t, kNtlmHashLen> hash);
...
#endif  // SYSTEM_PROXY_NET_NTLM_NTLM_H_

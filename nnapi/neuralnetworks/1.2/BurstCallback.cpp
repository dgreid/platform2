...
IBurstCallback::castFrom(
  ...
  // return ::android::hardware::details::castInterface<IBurstCallback,
  // ::android::hidl::base::V1_0::IBase, BpHwBurstCallback>(
  //         parent, "android.hardware.neuralnetworks@1.2::IBurstCallback",
  //         emitError);
}

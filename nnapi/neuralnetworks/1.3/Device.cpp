...
const char* IDevice::descriptor("android.hardware.neuralnetworks@1.3::IDevice");

::android::hardware::Return<void> IDevice::interfaceChain(
    interfaceChain_cb _hidl_cb) {
  _hidl_cb({
      ::android::hardware::neuralnetworks::V1_3::IDevice::descriptor,
...
::android::hardware::Return<void> IDevice::interfaceDescriptor(
  ...
  _hidl_cb(::android::hardware::neuralnetworks::V1_3::IDevice::descriptor);
  return ::android::hardware::Void();
}
...
::android::hardware::Return<void> IDevice::getHashChain(
  ...
  _hidl_cb(
      {/* 278817920bfd5292a7713f97f1832cca53de3de640f7670e413d97c6e7fd581c */
       (uint8_t[32]){39,  136, 23,  146, 11,  253, 82,  146, 167, 113, 63,
                     151, 241, 131, 44,  202, 83,  222, 61,  230, 64,  247,
                     103, 14,  65,  61,  151, 198, 231, 253, 88,  28},

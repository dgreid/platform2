...
::android::hardware::Return<void> IPreparedModelCallback::interfaceDescriptor(
  ...
  _hidl_cb(::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback::
               descriptor);
  return ::android::hardware::Void();
}
...
::android::hardware::Return<void> IPreparedModelCallback::getHashChain(
  ...
  _hidl_cb({
        (uint8_t[32]){238, 227, 67, 12, 200, 108, 151, 199, 180, 7, 73, 88, 99,
        216, 251, 97, 218, 111, 26, 100, 183, 114, 30, 119, 185, 180, 144, 155,
        17, 177, 116, 233}
        /* eee3430cc86c97c7b407495863d8fb61da6f1a64b7721e77b9b4909b11b174e9 */,
        (uint8_t[32]){225, 199, 52, 209, 84, 94, 26, 74, 231, 73, 255, 29, 217,
        112, 74, 142, 89, 76, 89, 174, 167, 200, 54, 49, 89, 220, 37, 142, 147,
        224, 223, 59}
        /* e1c734d1545e1a4ae749ff1dd9704a8e594c59aea7c8363159dc258e93e0df3b */,
        (uint8_t[32]){115, 224, 53, 115, 73, 75, 169, 111, 14, 113, 26, 183,
        241, 149, 108, 91, 45, 84, 195, 218, 105, 12, 215, 236, 244, 214, 208,
        242, 135, 68, 119, 48}
...
IPreparedModelCallback::castFrom(
  ...
  return ::android::hardware::details::castInterface<
      ...
      parent, "android.hardware.neuralnetworks@1.3::IPreparedModelCallback",
      emitError);
}

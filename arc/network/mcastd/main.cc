...
int main(int argc, char* argv[]) {
  ...
  auto mdns_fwd = std::make_unique<arc_networkd::MulticastForwarder>(
      args[0], arc_networkd::kMdnsMcastAddress,
      arc_networkd::kMdnsMcastAddress6, arc_networkd::kMdnsPort);

  auto ssdp_fwd = std::make_unique<arc_networkd::MulticastForwarder>(
      args[0], arc_networkd::kSsdpMcastAddress,
      arc_networkd::kSsdpMcastAddress6, arc_networkd::kSsdpPort);

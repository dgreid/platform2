...
#ifndef DIAGNOSTICS_CROS_HEALTHD_EVENT_TOOL_LID_SUBSCRIBER_H_
#define DIAGNOSTICS_CROS_HEALTHD_EVENT_TOOL_LID_SUBSCRIBER_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_EVENT_TOOL_LID_SUBSCRIBER_H_

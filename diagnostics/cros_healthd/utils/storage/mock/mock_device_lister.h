...
#ifndef DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_MOCK_MOCK_DEVICE_LISTER_H_
#define DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_MOCK_MOCK_DEVICE_LISTER_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_MOCK_MOCK_DEVICE_LISTER_H_

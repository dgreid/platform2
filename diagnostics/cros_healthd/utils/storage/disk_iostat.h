...
#ifndef DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_DISK_IOSTAT_H_
#define DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_DISK_IOSTAT_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_UTILS_STORAGE_DISK_IOSTAT_H_
